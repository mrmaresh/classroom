...
class Schedule (models.Model):
    ...
    period_0 = models.TimeField()
    period_1 = models.TimeField()
    period_2 = models.TimeField()
    period_3 = models.TimeField()
    period_4 = models.TimeField()
    period_5 = models.TimeField()
    period_6 = models.TimeField()
    period_7 = models.TimeField()
    period_8 = models.TimeField()