...
class StudentAdmin (ImportExportMixin, admin.ModelAdmin):
    list_display = ("first", "last", "student_id", "period", "grade", "exception", "augPass", "sepPass", "octPass", "novPass", "decPass", "janPass", "febPass", "marPass", "aprPass", "mayPass", "junPass", "julPass", "responses", "absent", "id")
